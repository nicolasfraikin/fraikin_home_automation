...
def create_arduino_interface_bluetooth_sender(output_file, template_path, interface_list, interface_short_list):
    ...
    res["InterfaceNamePascalCase"] = [pascal_case(interface) for interface in interface_short_list]
...
if __name__ == "__main__":
    ...
    print("##### INTERFACE LIST SENDER" + str(interface_list))

    create_arduino_interface_bluetooth_sender(output_file, template_path, interface_list, interface_short_list)

...
def create_arduino_interface_bluetooth_receiver(output_file, template_path, interface_list, interface_short_list, interface_data_type_list):
...
if __name__ == "__main__":
    ...
    create_arduino_interface_bluetooth_receiver(output_file, template_path, interface_list, interface_short_list,interface_data_type_list)

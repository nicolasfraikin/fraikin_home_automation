...
def create_raspi_serial_interface_receiver(output_file, template_path, interface_list):
    # Render the template with the given parameters
    res = {}
    res["InterfaceNameSnakeCase"] = interface_list
    res["InterfaceNamePascalCase1"] = [pascal_case(interface) for interface in interface_list]
...
if __name__ == "__main__":
    ...
    create_raspi_serial_interface_receiver(output_file, template_path, interface_list)

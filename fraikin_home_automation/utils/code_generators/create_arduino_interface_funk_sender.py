...
def create_arduino_interface_funk_sender(output_file, template_path, interface_list, interface_short_list):
...
if __name__ == "__main__":
    ...
    create_arduino_interface_funk_sender(output_file, template_path, interface_list, interface_short_list)

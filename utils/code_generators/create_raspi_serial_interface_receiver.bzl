GENERATOR = "//fraikin_home_automation/utils/code_generators:create_raspi_serial_interface_receiver"
TEMPLATE_PATH = "templates/raspi_serial_interface_receiver_py.jinja"

def _create_raspi_serial_interface_receiver_impl(ctx):
    # Define output files
...
create_raspi_serial_interface_receiver = rule(
    _create_raspi_serial_interface_receiver_impl,

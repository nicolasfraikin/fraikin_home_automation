GENERATOR = "//fraikin_home_automation/utils/code_generators:create_raspi_interface_sender"
TEMPLATE_PATH = "templates/raspi_interface_sender_py.jinja"

def _create_raspi_interface_sender_impl(ctx):
    # Define output files
...
create_raspi_interface_sender = rule(
    _create_raspi_interface_sender_impl,
